...
insert into page (name, user_id, last_publish_date, display)
values ('home_main', 1, now(), 'Home');

--must add dummy value in page
insert into page_home_main (text, heading, status_id, page_id, user_id, update_date, create_date)
values ("blank", "blank", 1, 1, 1, now(), now());
